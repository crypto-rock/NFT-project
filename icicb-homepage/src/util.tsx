...
const toHex = (buf:ArrayBuffer) => Array.from(new Uint8Array(buf)).map(n => n.toString(16).padStart(2, "0")).join("");

export const hmac256 = async (message, secret) => {
	/* let secret = "SecretKey"; // the secret key */
